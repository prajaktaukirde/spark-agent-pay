...
{`{
  ...
  "inputSchema": {
    ...
    "required": ["user_goal"]
      ...
      {/* Permanently Masked & Secured Credentials Card */}
      <div className="rounded-xl border border-border bg-surface/50 p-5 space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-xs font-semibold text-foreground">
            <Lock className="h-4 w-4 text-primary" />
            Active Gateway &amp; AI Credentials
          </div>
          <span className="inline-flex items-center gap-1 rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-semibold text-primary">
            <ShieldCheck className="h-3 w-3" /> Fully Redacted &amp; Encrypted
          </span>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 text-xs">
          ...
          <div className="rounded-lg border border-border bg-background/80 p-3 space-y-1.5">
            ...
            <p className="font-mono text-xs text-primary font-medium tracking-widest select-none">
              rzp_test_••••••••••••••••
            </p>
          </div>
          ...
          <div className="rounded-lg border border-border bg-background/80 p-3 space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] text-indigo-400 font-medium">● Secured in .env</span>
            </div>
            <p className="font-mono text-xs text-indigo-400 font-medium tracking-widest select-none">
              ••••••••••••••••••••••••••••••••
            </p>
          </div>
        </div>
        ...
        <p className="text-[11px] text-muted-foreground">
          All API secrets and private keys are secured in backend environment variables and are permanently non-revealable from public browser sessions.
        </p>
      </div>
    </div>
  );
